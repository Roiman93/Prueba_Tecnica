...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-11-2022 a las 05:36:16
...
(1, 'Aitor', 'albert', 1, 'A', 'aitor@google.com', '345346-54', '10.253652685182912,-75.34695290787532', 1),
(2, 'Soila', 'Puerta del Corral', 1, 'B', 'sp@nasa.gov', '6244566', '10.249488499691639,-75.3477954475428', 1),
(3, 'Pere', 'Gil', 1, 'A', 'PERE@SAMSUNG.COM', '73563456', '10.249799123271258,-75.34925152563993', 1),
...
--
ALTER TABLE `test_courses`
  MODIFY `c_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT de la tabla `test_courses_x_student`
--
ALTER TABLE `test_courses_x_student`
  MODIFY `cxs_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;

--
-- AUTO_INCREMENT de la tabla `test_students`
--
ALTER TABLE `test_students`
  MODIFY `s_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;
